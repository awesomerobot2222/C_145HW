...
def myCardDetails():
    ...
    print(type(Date pf birth))
    Pin no. = 8232
    print(type(Pin no.))
    Address = 23345 washington road
    print(type(Address))
    Authorisation to drive the following vehicles = lambo, bugati
    print(type(Authorisation to drive the following vehicles))
    
    label_name['text'] = name
    label_grade['text'] = grade
    label_subjects['test'] = subjects
